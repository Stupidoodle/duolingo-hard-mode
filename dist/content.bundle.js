...
/* harmony export */ });
/* harmony import */ var _ExtensionEventManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExtensionEventManager.js */ "./src/ExtensionEventManager.js");
/* harmony import */ var _WordBank_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WordBank.js */ "./src/WordBank.js");
...
var Challenge = /*#__PURE__*/function () {
   ...
   */
  function Challenge(challengeDiv, eventManager) {
    _classCallCheck(this, Challenge);
    /** @type {WordBank | null} */
    _defineProperty(this, "remainingChoices", null);
    /** @type {HTMLElement} */
    ...
    /** @type {WordBank} */
    this.wordBank = new _WordBank_js__WEBPACK_IMPORTED_MODULE_1__.WordBank(this.challengeDiv.querySelector("div[data-test='word-bank']"));

    /** @type {WordBank} */
    this.remainingChoices = new _WordBank_js__WEBPACK_IMPORTED_MODULE_1__.WordBank(this.challengeDiv.querySelector("div[data-test='word-bank']"));
  ...
  return _createClass(Challenge, [{
    ...
    value: function handleSpace() {
      ...
      if (this.remainingChoices.wordMap.has(userInput) && this.remainingChoices.wordMap.get(userInput).length > 0) {
        ...
        setTimeout(function () {
          _this.elements.inputField.style.border = "2px solid rgb(var(--color-swan))";
          _this.elements.inputField.style.animation = "";
        }, 300);
      }
    }
...
var ChallengeTapComplete = /*#__PURE__*/function (_Challenge) {
  ...
  function ChallengeTapComplete(challengeDiv, eventManager) {
    ...
    return _callSuper(this, ChallengeTapComplete, [challengeDiv, eventManager]);
  }
  ...
  return _createClass(ChallengeTapComplete, [{
    ...
    value: function handleBackspace() {
      ...
      var words = this.cleanInputText();
      if (words.length === 0) {
        return;
      }
      var removedWordIndex = -1;
      var text = this.elements.inputField.value;
      ...
      if (removedWord && removedWordIndex !== -1) {
        console.debug("Re-enabling ".concat(removedWord, " at index ").concat(removedWordIndex));
        ...
        var buttons = _toConsumableArray(document.querySelectorAll("button[data-test='".concat(dataTestValue, "']"))).filter(function (btn) {
          var _btn$querySelector;
          return btn.getAttribute("aria-disabled") === "false" && ((_btn$querySelector = btn.querySelector("[data-test='challenge-tap-token-text']")) === null || _btn$querySelector === void 0 ? void 0 : _btn$querySelector.textContent.trim()) === removedWord;
        });
        console.debug(buttons);

        // Select the button at the same position as the removed word
        var targetButton = buttons[removedWordIndex] || buttons.at(-1); // Fallback to last if out of range
...
var ChallengeTranslate = /*#__PURE__*/function (_Challenge) {
  ...
  function ChallengeTranslate(challengeDiv, eventManager) {
    ...
    return _callSuper(this, ChallengeTranslate, [challengeDiv, eventManager]);
  }
